                ...
                <table className={table.table} >
                    <tbody className={table.tbody} >
                        <tr className={table.tr}>
                            <Button id='1'  class={this.state.col1[5]}/>
                        ...
                        <tr className={table.tr}>
                           ...
                           <tr>
                            <td className='table.flex'>
                                <button onClick={()=>this.onClickColumn("col1")}>1</button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn("col2")}>
                                   2
                               </button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn("col3")}>
                                   3
                               </button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn("col4")}>
                                   4
                               </button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn("col5")}>
                                   5
                               </button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn('col6')}>
                                   6
                               </button></td>
                               <td>
                                <button onClick={()=>this.onClickColumn("col7")}>
                                   7
                               </button></td>
